...
<body>
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $sql   = "INSERT INTO news (id, title, author_id, category_id, date, foto, headline, content, tag_id) VALUES (null, '$title', '$author_id', '$category_id', CURRENT_TIMESTAMP(), '$foto', '$headline', '$content', '$tag_id');";
            ...
            <div class="container-fluid">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Menambahkan Berita</li>
                    </ol>
                </nav>
                <h1 class="h2">Menambahkan Berita</h1>
                <p>Anda sedang menambahkan berita baru.</p>
                ...
                <div class="card">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="headline" name="headline" rows="3"></textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="tag_id" id="">
                                    <option>--Pilih Tag (Label)--</option>
                                    <?php
