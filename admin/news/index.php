...
<body>
    <?php
        ...
        news.date, news.category_id, categories.id as categoryID, categories.category FROM news 
    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            <div class="container-fluid">
                ...
                <p>Untuk menambah author silahkan klik <b>tombol + Berita Baru</b> dibawah.</p>

                <div class="card">
                    <div class="card-body">
                        <a class="btn btn-primary mb-4" href="create.php" style="color: white"><i class="fa-solid fa-plus"></i> Berita Baru</a>
                        <div class="table-responsive">
                            <table class="table" id="table">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                        <th scope="col" width="200px">Judul Berita</th>
