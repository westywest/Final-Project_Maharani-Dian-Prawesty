    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            <div class="container-fluid">
                ...
                <p>Untuk menambah Kategori Berita silahkan klik <b>tombol + Kategori Baru</b> dibawah.</p>

                <div class="card">
                    <div class="card-body">
                        <a class="btn btn-primary mb-4" href="create.php" style="color: white"><i class="fa-solid fa-plus"></i> Kategori Baru</a>
