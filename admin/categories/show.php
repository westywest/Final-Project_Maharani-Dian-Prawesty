    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            <div class="container-fluid">
                ...
                <p>Anda sedang melihat detail kategori <b><?php echo $category ?></b>.</p>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="deskripsi" placeholder="deskripsi" disabled><?php echo $deskripsi ?></textarea>
                            </div>
                        </div>
                    </div>
