...
<body>
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            include '../../connectDB.php';
            $sql = "UPDATE categories SET category = '$category', deskripsi = '$deskripsi' WHERE id = $id;";
            $datas = $conn->query($sql);
    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            <div class="container-fluid">
                ...
                <p>Anda sedang mengubah detail kategori dari <b><?php echo $category ?></b></p>
                    ...
                    <div class="card-body">
                        <form action="<?php echo $_SERVER['PHP_SELF']."?id=".$id ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="deskripsi"><?php echo $deskripsi ?></textarea>
                            </div>
