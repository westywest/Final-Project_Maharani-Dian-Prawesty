...
<body>
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = "UPDATE tag SET name_tag = '$name_tag' WHERE id = $id;";
            $datas = $conn->query($sql);
    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            <div class="container-fluid">
                ...
                <p>Anda sedang mengubah tag dari <b><?php echo $name_tag ?></b>.</p>
                    ...
                    <div class="card-body">
                        <form action="<?php echo $_SERVER['PHP_SELF']."?id=".$id ?>" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name_tag" name="name_tag" placeholder="name_tag" required value="<?php echo $name_tag ?>">
                            </div>
