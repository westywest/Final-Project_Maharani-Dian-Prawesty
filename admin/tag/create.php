...
<body>
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = "INSERT INTO tag (name_tag) VALUES ('$name_tag');";
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            <div class="container-fluid">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Daftar Tag</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Menambahkan Tag</li>
                    </ol>
                </nav>
                <h1 class="h2">Menambahkan Tag</h1>
                    ...
                    <div class="card-body">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name_tag" name="name_tag" placeholder="name_tag" required>
                            </div>
