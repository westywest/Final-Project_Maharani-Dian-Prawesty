            ...
            <div class="container-fluid">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Daftar Author</li>
                    </ol>
                </nav>
                <h1 class="h2">Daftar Author</h1>
                <p>Untuk menambah author silahkan klik <b>tombol + Author Baru</b> dibawah.</p>

                <div class="card">
                    <div class="card-body">
                        <a class="btn btn-primary mb-4" href="create.php" style="color: white"><i class="fa-solid fa-plus"></i> Author Baru</a>
                        <a href="../../cetak_author.php" class="btn btn-block btn-primary mb-4"><i class="fa-solid fa-print"></i></a>
                                            ...
                                            echo '
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-sm btn-primary buttons" href="../../cetak_detailAuthor.php?id='.$data['id'].'"><i class="fa-solid fa-print"></i></a>
                                                    </td>
                                                </tr>
                                            ';
                                        }
