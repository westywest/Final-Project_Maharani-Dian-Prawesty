...
<body>
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            include '../../connectDB.php';
            $sql = "UPDATE authors SET name = '$name', foto = '$foto', jk = '$jk', phone = '$phone', email = '$email' WHERE id = $id;";
            $datas = $conn->query($sql);
    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            <div class="container-fluid">
                ...
                <p>Anda sedang mengubah detail author dari <b><?php echo $name ?></b></p>
                    ...
                    <div class="card-body">
                        <form action="<?php echo $_SERVER['PHP_SELF']."?id=".$id ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <img class="img-thorlates" src="../../assets/upload/<?php echo $foto ?>" id="foto" alt="">
                            </div>
                            <div class="mb-3">
